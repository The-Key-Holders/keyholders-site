...
import { PersonaProvider } from "@/components/psap-portal/PersonaProvider";
...
export const metadata: Metadata = {
  ...
  description:
    "Cal OES PSAP funding, CPE contract transition (RFP 26-16743), SOW/invoice checkers, and Grok support agent — PSAP, Advisor, and Admin experiences.",
};
            ...
            <div className="flex flex-wrap items-center justify-between gap-3">
              <div>
                ...
                <p className="text-[11px] uppercase tracking-wider text-white/40">
                  The Key Holders · Role-based beta · Post-award Sept 2026+
                </p>
              </div>
        ...
        <footer className="relative mt-12 border-t border-white/10 py-8">
          <div className="mx-auto max-w-5xl space-y-2 px-4 text-xs text-white/40 sm:px-6">
            ...
            <p>
              ...
              for The Key Holders · Switch role anytime in the header
            </p>
          </div>
        </footer>
        <PsapPortalChat />
